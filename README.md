...
Once you are done with enviorment setup, you are ready to begin the tutorial!
Inside the `src` folder you should see modules `debug_training`, `topic_training`, `service_training` and `package_training` (among other modules), each with a markdown file.
You should go through the trainings in the following order:
- Debug Training @ [`src/debug_training/Debug_Training.md`](./src/debug_training/Debug_Training.md)
- Topic Training @ [`src/topic_training/Topic_Training.md`](./src/topic_training/Topic_Training.md)
- Service Training @ [`src/service_training/Service_Training.md`](./src/service_training/Service_Training.md)
- Package Training @ [`src/package_training/Package_Training.md`](./src/package_training/Package_Training.md)
